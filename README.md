...
6. The seat status is sent to Firebase Realtime Database.

7. The public web dashboard reads the latest data from Firebase.
...
The project includes a public web dashboard for viewing real-time seat availability.

Live Website:

Open Library Seat Availability Dashboard
...
The circuit diagram for the project is available below:
